...
public class ManagerialDetail extends AppCompatActivity {

    RecyclerView rvEvent;
    private List<Model> managerialEvents = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managerial_detail);
    ...
    private void LoadJson() {
        ...
        call.enqueue(new Callback<EventData>() {
            ...
            public void onResponse(Call<EventData> call, Response<EventData> response) {
                managerialEvents = response.body().getEventList();
                eventAdapter = new event_adapter(managerialEvents, ManagerialDetail.this);
